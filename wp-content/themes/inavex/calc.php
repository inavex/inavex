<?php
/**
 * Template Name: Страница - Калькулятор Износа
 */
...
$parent_id = get_the_ID(); ?>
    ...
    <div id="main-wrap" class="wrap">
        ...
        <div id="main-middle" class="row">
            ...
            <form action="/wp-content/themes/inavex/calculator/getCalcDoc/getCalcDocx.php" method="POST" id="calcForm">
                    ...
                    <div style="float: left; width: 560px;">
                        ...
                        <table class="b-table-calc">
                            ...
                            <tr>
                                ...
                                <td>
                                        <label for="vozrast-ts">Возраст ТС (лет)</label>
                                        <div class="">
                                            <input name="vozrast-ts" id="vozrast-ts" type="text" value="" class="medium span2-2" disabled  tabindex="1">
                                        </div>
                                </td>
                            </tr>
                ...
                <script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.dateentry.min.js"></script>
                <script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.dateentry-ru.js"></script>

                <script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/js/ui.datepicker-ru.js"></script>
                <script type="text/javascript">
                    jQuery(document).ready(function ($) {

                        //$(".datepicker").dateEntry().change(function() {});

                        $(".datepicker").datepicker();

                        var url = "/wp-content/themes/inavex/calculator/calculator.php";
