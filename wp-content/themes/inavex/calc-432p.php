            ...
            <form action="/wp-content/themes/inavex/calculator/getCalcDoc/getCalcDocx3.php" method="POST" id="calcForm">
                    ...
                    <div style="margin-bottom: 20px;">
                        <select name="deltaId" id="" class="span8-1" style="display: inline-block">
                            ...
                            <option value="1">Легковые автомобили, производства Российской Федерации</option>
                            <option value="2">Легковые автомобили, производства стран Азии (кроме Японии и Кореи)</option>
                            <option value="3">Легковые автомобили, производства стран Европы, включая Турцию </option>
                            <option value="4">Легковые автомобили, производства стран Северной и Южной Америк</option>
                            <option value="5">Легковые автомобили, производства Кореи</option>
                            <option value="6">Легковые автомобили, производства Японии</option>
