...
<?php _e('Автор', 'kubrick'); ?>: <a href="#" title="<?php _e('Author', 'kubrick'); ?>"><?php the_author() ?></a>
<?php $icons[] = ob_get_clean(); ?>
<?php endif; ?>
<?php if (current_user_can( 'edit_post', $post->ID )) : ?><?php ob_start(); ?>
<img src="<?php bloginfo('template_url'); ?>/images/PostEditIcon.png" width="20" height="20" alt="PostEditIcon" />
...
<?php endif; ?>
<div class="PostContent">
<?php if (is_search()) the_excerpt(); else the_content(__('далее', 'kubrick')); ?>
...
<?php printf(__('Рубрика', 'kubrick'), get_the_category_list(', ')); ?>
<?php $icons[] = ob_get_clean(); ?>
<?php endif; ?>
...
<img src="<?php bloginfo('template_url'); ?>/images/PostCommentsIcon.png" width="11" height="12" alt="PostCommentsIcon" />
