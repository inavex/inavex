...
require_once( FRAMESHIFT_WIDGETS_DIR . '/latest.php' );
require_once( FRAMESHIFT_WIDGETS_DIR . '/latest-work.php' );
require_once( FRAMESHIFT_WIDGETS_DIR . '/spaces.php' );
require_once( FRAMESHIFT_WIDGETS_DIR . '/post-spaces.php' );
require_once( FRAMESHIFT_WIDGETS_DIR . '/slider.php' );
require_once( FRAMESHIFT_WIDGETS_DIR . '/divider.php' );
require_once( FRAMESHIFT_WIDGETS_DIR . '/calltoaction.php' );
