            ...
            <h2>Customer Reviews - <?php echo $status_text; ?> Reviews</h2>
              ...
              <form method="GET" action="" id="search-form" name="search-form">
                  <p class="search-box">
                      ...
                      <label for="comment-search-input" class="screen-reader-text">Поиск отзывов:</label>
                      ...
                      <input type="submit" class="button" value="Поиск отзывов" />
                  </p>
              </form>

                <form method="POST" action="?page=wpcr_view_reviews">
                    <input type="hidden" name="yandexSync" value="1" />
                    <input type="submit" class="button" value="Синхронизировать с Yandex" style="margin: 8px 20px;"/>
                </form>
